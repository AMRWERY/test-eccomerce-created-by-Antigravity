...
declare global {
  ...
  const authDB: typeof import('./stores/plugins/authDB').authDB
  ...
  const initDB: typeof import('./stores/plugins/persistence').initDB
  ...
  const piniaIndexedDBPlugin: typeof import('./stores/plugins/persistence').piniaIndexedDBPlugin
